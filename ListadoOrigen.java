...
public class ListadoOrigen extends javax.swing.JInternalFrame {
    ...
    private void jtablaAeropuertosMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtablaAeropuertosMousePressed
        if (evt.getClickCount() == 2) {
            ...
            String Origen;
            String Pais;
            Origen = (jtablaAeropuertos.getValueAt(fila__seleccionada, 4).toString());
            Pais = (jtablaAeropuertos.getValueAt(fila__seleccionada, 3).toString());
            Vuelo.txtCiudadOrigen.setText(Origen + ", " + Pais);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoOrigen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoOrigen().setVisible(true);
            }
        });
    }
